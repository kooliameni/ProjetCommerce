...
class __TwigTemplate_a1f3672d78730af0074604380facbb7592193998b46acbae29c62e1ec6e3c061 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((!$this->getAttribute($this->getAttribute($this->getContext($context, "sonata_admin"), "field_description", array()), "hasassociationadmin", array()))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["element"]) {
                // line 13
                echo "        ";
                echo twig_escape_filter($this->env, $this->env->getExtension('sonata_admin')->renderRelationElement($context["element"], $this->getAttribute($this->getContext($context, "sonata_admin"), "field_description", array())), "html", null, true);
                echo "
    ";
            }
            ...
            if (($this->getAttribute($this->getContext($context, "sonata_admin"), "edit", array()) == "inline")) {
                ...
                if (($this->getAttribute($this->getContext($context, "sonata_admin"), "inline", array()) == "table")) {
                    ...
                    if ((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "form"), "children", array())) > 0)) {
                        ...
                        // line 25
                        $context['_parent'] = (array) $context;
                        $context['_seq'] = twig_ensure_traversable($this->getAttribute(twig_first($this->env, $this->getAttribute($this->getContext($context, "form"), "children", array())), "children", array()));
                        ...
                        foreach ($context['_seq'] as $context["nested_group_field_name"] => $context["nested_group_field"]) {
                            ...
                            foreach ($context['_seq'] as $context["field_name"] => $context["nested_field"]) {
                                ...
                                echo ">
                                                ";
                                // line 41
                                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "sonata_admin", true), "field_description", array(), "any", false, true), "associationadmin", array(), "any", false, true), "formfielddescriptions", array(), "any", false, true), $context["field_name"], array(), "array", true, true)) {
                                    // line 42
                                    echo "                                                    ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["nested_group_field"]) {
                        ...
                        // line 70
                        $context['_parent'] = (array) $context;
                        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "associationAdmin"), "formgroups", array()));
                        $context['loop'] = array(
                          'parent' => $context['_parent'],
                          'index0' => 0,
                          'index'  => 1,
                        ...
                        foreach ($context['_seq'] as $context["name"] => $context["form_group"]) {
                            ...
                            echo "\">
                                        <a href=\"#";
                            // line 72
                            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "associationAdmin"), "uniqid", array()), "html", null, true);
                            echo "_";
                            ...
                            echo "\" data-toggle=\"tab\">
                                            ...
                                            ";
                            // line 74
                            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "associationAdmin"), "trans", array(0 => $context["name"], 1 => array(), 2 => $this->getAttribute($context["form_group"], "translation_domain", array())), "method"), "html", null, true);
                            echo "
                                        </a>
                                    </li>
                                ";
                        ...
                        foreach ($context['_seq'] as $context["name"] => $context["form_group"]) {
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["field_name"]) {
                                ...
                                // line 87
                                echo "                                                    ";
                                if ($this->getAttribute($this->getAttribute($this->getContext($context, "associationAdmin", true), "formfielddescriptions", array(), "any", false, true), $context["field_name"], array(), "array", true, true)) {
                                    // line 88
                                    echo "                                                        ";
        ...
        ";
            ...
            ";
                ...
                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "sonata_admin", true), "field_description", array(), "any", false, true), "options", array(), "any", false, true), "sortable", array(), "any", true, true)) {
                    ...
                    echo twig_escape_filter($this->env, $this->getContext($context, "id"), "html", null, true);
                    echo "-";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "sonata_admin"), "field_description", array()), "options", array()), "sortable", array()), "html", null, true);
