...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.commande' => 'getSonata_Admin_CommandeService',
            ...
            'sonata.admin.produit' => 'getSonata_Admin_ProduitService',
            'sonata.admin.promotion' => 'getSonata_Admin_PromotionService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/wamp/www/BestCady2/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/wamp/www/BestCady2/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/wamp/www/BestCady2/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/wamp/www/BestCady2/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'cady', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array((dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle\\Resources\\config\\doctrine') => 'Sonata\\MediaBundle\\Entity', (dirname(dirname(dirname(__DIR__))).'\\src\\Application\\Sonata\\MediaBundle\\Resources\\config\\doctrine') => 'Application\\Sonata\\MediaBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\Cady\\UserBundle\\Entity'))), 'Cady\\UserBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('CadyUserBundle' => 'Cady\\UserBundle\\Entity', 'SonataMediaBundle' => 'Sonata\\MediaBundle\\Entity', 'ApplicationSonataMediaBundle' => 'Application\\Sonata\\MediaBundle\\Entity'));
        ...
        $c->setProxyDir('C:/wamp/wamp/www/BestCady2/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b07d2d8fe24293990c5b79d218a12b1aa161b9c6de12ec3e0880430cc1490a14');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/wamp/www/BestCady2/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Cady\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Cady\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Cady\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Cady\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Cady\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Sonata\\CoreBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\core-bundle/Resources/config/serializer'), 'Sonata\\BlockBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\block-bundle/Resources/config/serializer'), 'Knp\\Bundle\\MenuBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\knplabs\\knp-menu-bundle\\Knp\\Bundle\\MenuBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sensio\\framework-extra-bundle\\Sensio\\Bundle\\FrameworkExtraBundle/Resources/config/serializer'), 'Cady\\UserBundle' => (dirname(dirname(dirname(__DIR__))).'\\src\\Cady\\UserBundle/Resources/config/serializer'), 'FOS\\UserBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\friendsofsymfony\\user-bundle/Resources/config/serializer'), 'Sonata\\DoctrineORMAdminBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\doctrine-orm-admin-bundle/Resources/config/serializer'), 'Sonata\\AdminBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\admin-bundle/Resources/config/serializer'), 'Sonata\\MediaBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/config/serializer'), 'Sonata\\EasyExtendsBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\easy-extends-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'Application\\Sonata\\MediaBundle' => (dirname(dirname(dirname(__DIR__))).'\\src\\Application\\Sonata\\MediaBundle/Resources/config/serializer'), 'Acme\\DemoBundle' => (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\DemoBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => (dirname(dirname(dirname(__DIR__))).'\\vendor\\sensio\\generator-bundle\\Sensio\\Bundle\\GeneratorBundle/Resources/config/serializer')));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/wamp/www/BestCady2/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/wamp/www/BestCady2/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/wamp/www/BestCady2/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/wamp/www/BestCady2/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/wamp/www/BestCady2/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/wamp/www/BestCady2/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'sonata.admin.commande' service.
     *
     * @return \Cady\UserBundle\Admin\CommandeAdmin A Cady\UserBundle\Admin\CommandeAdmin instance.
     */
    protected function getSonata_Admin_CommandeService()
    {
        $instance = new \Cady\UserBundle\Admin\CommandeAdmin('sonata.admin.commande', 'Cady\\UserBundle\\Entity\\Commande', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('CadyUserBundle');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.post', 1 => 'sonata.admin.produit', 2 => 'sonata.admin.promotion', 3 => 'sonata.admin.commande', 4 => 'sonata.media.admin.media', 5 => 'sonata.media.admin.gallery', 6 => 'sonata.media.admin.gallery_has_media'));
        $instance->setAdminGroups(array('Gestion Magasin' => array('label' => 'Gestion Magasin', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.post', 1 => 'sonata.admin.produit', 2 => 'sonata.admin.promotion')), 'Commandes' => array('label' => 'Commandes', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.commande')), 'sonata_media' => array('label' => 'sonata_media', 'label_catalogue' => 'SonataMediaBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.media.admin.media', 1 => 'sonata.media.admin.gallery'))));
        $instance->setAdminClasses(array('Cady\\UserBundle\\Entity\\Categorie' => array(0 => 'sonata.admin.post'), 'Cady\\UserBundle\\Entity\\Produit' => array(0 => 'sonata.admin.produit'), 'Cady\\UserBundle\\Entity\\Promotion' => array(0 => 'sonata.admin.promotion'), 'Cady\\UserBundle\\Entity\\Commande' => array(0 => 'sonata.admin.commande'), 'Application\\Sonata\\MediaBundle\\Entity\\Media' => array(0 => 'sonata.media.admin.media'), 'Application\\Sonata\\MediaBundle\\Entity\\Gallery' => array(0 => 'sonata.media.admin.gallery'), 'Application\\Sonata\\MediaBundle\\Entity\\GalleryHasMedia' => array(0 => 'sonata.media.admin.gallery_has_media')));
     ...
     *
     * @return \Cady\UserBundle\Admin\PostAdmin A Cady\UserBundle\Admin\PostAdmin instance.
     */
    protected function getSonata_Admin_PostService()
    {
        $instance = new \Cady\UserBundle\Admin\PostAdmin('sonata.admin.post', 'Cady\\UserBundle\\Entity\\Categorie', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.produit' service.
     *
     * @return \Cady\UserBundle\Admin\ProduitAdmin A Cady\UserBundle\Admin\ProduitAdmin instance.
     */
    protected function getSonata_Admin_ProduitService()
    {
        $instance = new \Cady\UserBundle\Admin\ProduitAdmin('sonata.admin.produit', 'Cady\\UserBundle\\Entity\\Produit', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.promotion' service.
     *
     * @return \Cady\UserBundle\Admin\PromotionAdmin A Cady\UserBundle\Admin\PromotionAdmin instance.
     */
    protected function getSonata_Admin_PromotionService()
    {
        $instance = new \Cady\UserBundle\Admin\PromotionAdmin('sonata.admin.promotion', 'Cady\\UserBundle\\Entity\\Promotion', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('C:/wamp/wamp/www/BestCady2/app/cache/dev/sonata/admin', true);
    }
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.post', 1 => 'sonata.admin.produit', 2 => 'sonata.admin.promotion', 3 => 'sonata.admin.commande', 4 => 'sonata.media.admin.media', 5 => 'sonata.media.admin.gallery', 6 => 'sonata.media.admin.gallery_has_media'), $this);
    }
    ...
    {
        return $this->services['sonata.media.adapter.filesystem.local'] = new \Sonata\MediaBundle\Filesystem\Local('C:/wamp/wamp/www/BestCady2/app/../web/uploads/media', false);
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/wamp/www/BestCady2/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Cady\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.bg.xliff'), 'bg', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.de.xliff'), 'de', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.en.xliff'), 'en', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.es.xliff'), 'es', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.fr.xliff'), 'fr', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.hu.xliff'), 'hu', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.lt.xliff'), 'lt', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.nl.xliff'), 'nl', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.pl.xliff'), 'pl', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.pt_BR.xliff'), 'pt_BR', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.ru.xliff'), 'ru', 'SonataMediaBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.sl.xliff'), 'sl', 'SonataMediaBundle');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/wamp/www/BestCady2/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Cady\\UserBundle/Resources/views'), 'CadyUser');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\sonata-project\\media-bundle/Resources/views'), 'SonataMedia');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Application\\Sonata\\MediaBundle/Resources/views'), 'ApplicationSonataMedia');
        ...
        $instance->addPath('C:/wamp/wamp/www/BestCady2/app/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/wamp/www/BestCady2/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/wamp/www/BestCady2/app/cache/dev/assetic/assets');
    }
    ...
    protected function getJmsSerializer_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/wamp/wamp/www/BestCady2/app/cache/dev/jms_serializer'));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/wamp/www/BestCady2/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/wamp/www/BestCady2/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/wamp/www/BestCady2/app/logs',
            'kernel.bundles' => array(
                ...
                'CadyUserBundle' => 'Cady\\UserBundle\\CadyUserBundle',
            ...
            'debug.container.dump' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/wamp/www/BestCady2/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/wamp/www/BestCady2/app/../web',
            'assetic.write_to' => 'C:/wamp/wamp/www/BestCady2/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/wamp/www/BestCady2/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Cady\\UserBundle\\Entity\\Utilisateur',
