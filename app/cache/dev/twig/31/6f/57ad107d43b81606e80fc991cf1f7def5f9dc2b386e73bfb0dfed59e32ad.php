...
class __TwigTemplate_316f57ad107d43b81606e80fc991cf1f7def5f9dc2b386e73bfb0dfed59e32ad extends Twig_Template
{
...
<h1>";
        // line 20
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "gallery"), "name", array()), "html", null, true);
        echo "</h1>
...
<div class=\"sonata-media-gallery-media-list\">
    ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "gallery"), "GalleryHasMedias", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["galleryHasMedia"]) {
            ...
            echo "\">
                ";
            // line 26
            echo $this->env->getExtension('sonata_media')->thumbnail($this->getAttribute($context["galleryHasMedia"], "media", array()), $this->getAttribute($this->getContext($context, "gallery"), "defaultFormat", array()), array("class" => "media-object"));
            // line 27
            echo "            </a>
...
";
    ...
    public function block_sonata_page_breadcrumb($context, array $blocks = array())
    {
        ...
        ";
        // line 16
        echo call_user_func_array($this->env->getFunction('sonata_block_render_event')->getCallable(), array("breadcrumb", array("context" => "gallery_view", "gallery" => $this->getContext($context, "gallery"), "current_uri" => $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request", array()), "requestUri", array()))));
        echo "
    </div>
";
    }
