...
class __TwigTemplate_a2a7ae373b3fce7fc4dd8bf714a7d2fc4e6b3d51e6d3b5c579566f7076361759 extends Twig_Template
{
    ...
    public function block_block($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getContext($context, "admin"), "hasRoute", array(0 => "list"), "method")) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($this->getAttribute($this->getContext($context, "admin"), "label", array()), array(), $this->getAttribute($this->getContext($context, "admin"), "translationdomain", array())), "html", null, true);
            echo "</a>
                ";
        } else {
            // line 21
        ...
        if ($this->getContext($context, "pager")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
                ...
                if ($this->getAttribute($this->getContext($context, "admin"), "hasRoute", array(0 => "edit"), "method")) {
                    // line 34
                    echo "                        <li><a href=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "generateObjectUrl", array(0 => "edit", 1 => $context["result"]), "method"), "html", null, true);
                    echo "\">";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "toString", array(0 => $context["result"]), "method"), "html", null, true);
                    echo "</a></li>
                    ";
                } else {
                    // line 36
