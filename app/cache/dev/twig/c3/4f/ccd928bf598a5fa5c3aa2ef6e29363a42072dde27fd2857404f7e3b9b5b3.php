...
class __TwigTemplate_c34fccd928bf598a5fa5c3aa2ef6e29363a42072dde27fd2857404f7e3b9b5b3 extends Twig_Template
{
    ...
    public function block_item($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getContext($context, "item"), "displayed", array())) {
            ...
            } elseif ($this->getAttribute($this->getContext($context, "item"), "currentAncestor", array())) {
                // line 31
            ...
            echo "        ";
            // line 44
            if (((!twig_test_empty($this->getAttribute($this->getContext($context, "item"), "uri", array()))) && ((!$this->getAttribute($this->getContext($context, "item"), "current", array())) || $this->getAttribute($this->getContext($context, "options"), "currentAsLink", array())))) {
                // line 45
                echo "            ";
    ...
    public function block_linkElement($context, array $blocks = array())
    {
        ...
        echo "\"";
        echo $this->getAttribute($this->getContext($context, "macros"), "attributes", array(0 => twig_array_merge(twig_array_merge($this->getAttribute($this->getContext($context, "item"), "attributes", array()), $this->getAttribute($this->getContext($context, "item"), "linkAttributes", array())), $this->getContext($context, "attributes"))), "method");
        echo ">";
    ...
    {
        echo "<div";
        echo $this->getAttribute($this->getContext($context, "macros"), "attributes", array(0 => twig_array_merge(twig_array_merge($this->getAttribute($this->getContext($context, "item"), "attributes", array()), $this->getAttribute($this->getContext($context, "item"), "labelAttributes", array())), $this->getContext($context, "attributes"))), "method");
